...
const atual = localStorage.getItem("pedidoNumero")

if(!atual){
localStorage.setItem("pedidoNumero","100")
return 100
}

const novo = Number(atual) + 1
localStorage.setItem("pedidoNumero", String(novo))
...
alert("Pedido enviado com sucesso! Nº " + numeroPedido)
...
<input
placeholder="Seu WhatsApp (ex: 31999999999)"
